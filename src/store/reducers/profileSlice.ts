...
export const getUserPhoto = createAsyncThunk(
    'get/userPhoto', async (userId: string) => {
        return (await AxiosApi.profile.getPhoto(userId))
    })
...
export type userReducer =  SliceActions<typeof profileSlice.actions>
export type dispatchUserReducerType= (value: string) => userReducer
export type userSliceType = ReturnType<typeof profileSlice.reducer>;
